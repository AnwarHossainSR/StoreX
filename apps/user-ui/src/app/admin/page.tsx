...
import { BarChart, Bar, LineChart, Line, AreaChart, Area, PieChart, Pie, ResponsiveContainer, XAxis, YAxis, CartesianGrid, Tooltip, Cell, Legend } from 'recharts';
import { Layout, User, Package, CreditCard, Calendar, AlertCircle, CheckCircle, Clock } from 'lucide-react';
...
const recentOrders = [
  { id: 'ORD-001', customer: 'John Doe', amount: 250, status: 'Paid', date: '2023-05-12' },
  { id: 'ORD-002', customer: 'Jane Smith', amount: 180, status: 'Pending', date: '2023-05-11' },
  { id: 'ORD-003', customer: 'Alice Johnson', amount: 340, status: 'Paid', date: '2023-05-10' },
  { id: 'ORD-004', customer: 'Bob Wilson', amount: 120, status: 'Cancelled', date: '2023-05-09' },
  { id: 'ORD-005', customer: 'Emma Davis', amount: 560, status: 'Paid', date: '2023-05-08' },
];
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="text-sm text-gray-500">Last 6 months performance</div>
            </div>
            <div className="h-80">
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="text-sm text-gray-500">How users access your platform</div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-sm">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-500">A quick snapshot of your latest transactions.</p>
          </div>
